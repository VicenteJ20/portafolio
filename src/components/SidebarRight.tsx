...
export const SidebarRight = () => {
  return (
    <div className='hidden lg:flex flex-col gap-12 items-center py-10 px-6 bg-white fixed h-screen right-0 top-0 border-l-2 border-stone-300 max-w-2xl min-w-fit dark:bg-zinc-900 dark:border-zinc-700 dark:text-white'>
      ...
      <div className='portfolio-promo bg-gray-500 dark:bg-zinc-800 w-full h-32 rounded-md flex flex-col text-center gap-4 items-center justify-center py-8'>
        <h3 className='text-base font-bold px-6'>¿Te gusta el contenido?</h3>
